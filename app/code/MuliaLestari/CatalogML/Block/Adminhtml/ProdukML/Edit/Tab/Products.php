...
use MuliaLestari\CatalogML\Model\ContactFactory;
...
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        /* @var $model \MuliaLestari\CatalogML\Model\Slide */
        $model = $this->_objectManager->get('\MuliaLestari\CatalogML\Model\ProdukML');

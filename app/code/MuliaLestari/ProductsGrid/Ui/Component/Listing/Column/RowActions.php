...
namespace MuliaLestari\ProductsGrid\Ui\Component\Listing\Column;
...
{
    /** Url path */
    const CONTACTS_URL_PATH_EDIT = 'wsproductsgrid/produkmaster/edit';
    const CONTACTS_URL_PATH_DELETE = 'wsproductsgrid/produkmaster/delete';
                ...
                if (isset($item['produk_id'])) {
                    ...
                    $item[$name]['delete'] = [
                        ...
                        'confirm' => [
                            ...
                            'message' => __('Anda yakin ingin menghapus master produk "${ $.$data.nama }"?')
                        ]
                    ];
                }
            }
